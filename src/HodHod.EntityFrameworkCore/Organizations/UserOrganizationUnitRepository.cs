...
public class UserOrganizationUnitRepository : HodHodRepositoryBase<UserOrganizationUnit, long>,
    IUserOrganizationUnitRepository
{
    public UserOrganizationUnitRepository(IDbContextProvider<HodHodDbContext> dbContextProvider)
