...
namespace HodHod.Migrations
{
    ...
    [Migration("20250802105511_AddHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HodHod.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HodHod.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HodHod.BlackLists.BlackListEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppBlackListEntries");
                });

            modelBuilder.Entity("HodHod.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HodHod.Categories.SubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HodHod.Geo.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HodHod.Geo.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HodHod.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HodHod.Reports.PhoneReportLimit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppPhoneReportLimits");
                });
            ...
            modelBuilder.Entity("HodHod.Reports.Report", b =>
                {
                    ...
                    b.Property<long?>("PersianCreationTime")
                        .HasColumnType("bigint");

                    b.Property<long?>("PersianDeletionTime")
                        .HasColumnType("bigint");

                    b.Property<long?>("PersianLastModificationTime")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HodHod.Reports.ReportHistoryLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppReportHistoryLogs");
                });
            ...
            modelBuilder.Entity("HodHod.Reports.ReportNoteComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppReportNoteComments");
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("HodHod.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("HodHod.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("HodHod.Categories.SubCategory", b =>
                {
                    b.HasOne("HodHod.Categories.Category", "Category")
            ...
            modelBuilder.Entity("HodHod.Geo.City", b =>
                {
                    b.HasOne("HodHod.Geo.Province", "Province")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("HodHod.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.HasOne("HodHod.MultiTenancy.Payments.SubscriptionPayment", null)
            ...
            modelBuilder.Entity("HodHod.Reports.Report", b =>
                {
                    ...
                    b.HasOne("HodHod.Categories.SubCategory", "SubCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("HodHod.Reports.ReportNoteComment", b =>
                {
                    b.HasOne("HodHod.Reports.ReportNote", "Note")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("HodHod.Reports.ReportReferral", b =>
                {
                    ...
                    b.HasOne("HodHod.Reports.ReportReferral", "Parent")
                        .WithMany("Replies")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);
