...
public class SubscriptionPaymentRepository : HodHodRepositoryBase<SubscriptionPayment, long>,
    ISubscriptionPaymentRepository
{
    public SubscriptionPaymentRepository(IDbContextProvider<HodHodDbContext> dbContextProvider)
