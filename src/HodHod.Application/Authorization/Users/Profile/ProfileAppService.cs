...
using HodHod.Authorization.Users.Profile.Cache;
...
[AbpAuthorize]
public class ProfileAppService : HodHodAppServiceBase, IProfileAppService
{
    ...
    public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
    {
        ...
        userProfileEditDto.QrCodeSetupImageUrl = userProfileEditDto.IsGoogleAuthenticatorEnabled
            ? _googleTwoFactorAuthenticateService.GenerateSetupCode("HodHod",
