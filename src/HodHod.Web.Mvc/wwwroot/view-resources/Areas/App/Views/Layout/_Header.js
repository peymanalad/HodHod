(function ($) {
  $(function () {
    ...
    var mySettingsModal = new app.ModalManager({
      ...
      scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Profile/_MySettingsModal.min.js',
    ...
    var changePasswordModal = new app.ModalManager({
      ...
      scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Profile/_ChangePasswordModal.min.js',
    ...
    var changeProfilePictureModal = new app.ModalManager({
      ...
      scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Profile/_ChangePictureModal.min.js',
    ...
    var manageLinkedAccountsModal = new app.ModalManager({
      ...
      scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Profile/_LinkedAccountsModal.min.js',
    ...
    function shouldUserUpdateApp() {
      _notificationService.shouldUserUpdateApp().done((result) => {
        if (result) {
          abp.message.confirm(null, app.localize('NewVersionAvailableNotification'), function (isConfirmed) {
            if (isConfirmed) {
              abp
                .ajax({
    ...
    var userDelegationsModal = new app.ModalManager({
      ...
      scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Profile/_UserDelegationsModal.min.js',
