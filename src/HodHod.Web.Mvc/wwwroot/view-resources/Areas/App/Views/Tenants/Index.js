(function () {
  $(function () {
    ...
    var _entityTypeFullName = 'HodHod.MultiTenancy.Tenant';
    ...
    var _permissions = {
      ...
      history: abp.auth.hasPermission('Pages.Administration.EntityChanges.FullHistory'),
            ...
            items: [
              ...
              },
              {
                ...
                visible: function (data) {
                  return _permissions.unlock && data.record.isTenantAdminLocked;
                },
                action: function (data) {
                  _tenantService
                    .unlockTenantAdmin({
              ...
              },
              {
                ...
                visible: function () {
                  return entityHistoryIsEnabled() && _permissions.history;
                },
                action: function (data) {
                  window.location.href =
                    abp.appPath + `App/EntityChanges/${data.record.id}/${_entityTypeFullName}`;
                },
              },
            ],
          },
