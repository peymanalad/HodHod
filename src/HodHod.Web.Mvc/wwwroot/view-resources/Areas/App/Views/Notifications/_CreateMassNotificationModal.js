(function ($) {
  app.modals.CreateMassNotificationModal = function () {
    ...
    var _organizationUnitLookupTableModal = new app.ModalManager({
      ...
      scriptUrl:
        abp.appPath + 'view-resources/Areas/App/Views/Notifications/_OrganizationUnitLookupTableModal.js',
    ...
    this.init = function (modalManager) {
      ...
      _$massNotificationForm = _modalManager.getModal().find('form[name=MassNotificationForm]');
    ...
    $('#CreateMassNotificationModal_TargetNotifiers').change(function () {
      ...
      var isSMSSelected =
        selectedTargetNotifiers.indexOf('HodHod.Notifications.SmsRealTimeNotifier') >= 0;
