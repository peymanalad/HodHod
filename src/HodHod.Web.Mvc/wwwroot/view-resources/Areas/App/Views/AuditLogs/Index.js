(function ($) {
  $(function () {
    ...
    var _permissions = {
      allDetailEntityChanges: abp.auth.hasPermission('Pages.Administration.EntityChanges.FullHistory'),
    };
      ...
      columnDefs: [
        ...
        },
        {
          ...
          rowAction: {
            ...
            items: [
              {
                text: app.localize('AllChanges'),
                title: app.localize('EntityChangeAllDetailTooltipTitle'),
                visible: function () {
                  return _permissions.allDetailEntityChanges;
                },
                action: function (data) {
                  window.location.href =
                    abp.appPath + `App/EntityChanges/${data.record.entityId}/${data.record.entityTypeFullName}`;
                },
              },
              {
                text: app.localize('ViewChange'),
                title: app.localize('EntityChangeDetailTooltip'),
                action: function (data) {
                  showEntityChangeDetails(data.record);
                },
              },
            ],
          },
        ...
        },
        {
          ...
          render: function (userName) {
            return app.localize(userName);
          },
        },
        {
          targets: 5,
          data: 'impersonatorUserName',
          orderable: false,
          render: function (impersonatorUserName) {
            return app.localize(impersonatorUserName);
          },
        },
        {
          targets: 6,
