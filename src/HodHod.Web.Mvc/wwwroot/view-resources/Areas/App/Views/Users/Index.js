(function () {
  $(function () {
              ...
              },
              {
                ...
                visible: function () {
                  return _dynamicEntityPropertyManager.canShow(
                    'HodHod.Authorization.Users.User',
                  );
                },
                action: function (data) {
                  _dynamicEntityPropertyManager.modal.open({
                    entityFullName: 'HodHod.Authorization.Users.User',
    ...
    var url = abp.appPath + 'App/Users/ImportFromExcel';
    const id = '#ImportUsersFromExcelButton';
    let dropZone;
