var app = app || {};
(function () {
  var appLocalizationSource = abp.localization.getSource('HodHod');
  ...
  app.createDateTimePickerOptions = function (timePicker = false, localeFormat = null) {
    var options = {
      locale: {
    ...
    if (localeFormat) {
      options.locale.format = localeFormat;
    }
