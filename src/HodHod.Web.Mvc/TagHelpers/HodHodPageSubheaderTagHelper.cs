...
namespace HodHod.Web.TagHelpers;
...
public class HodHodPageSubheaderTagHelper : TagHelper
{
    ...
    public HodHodPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
    {
