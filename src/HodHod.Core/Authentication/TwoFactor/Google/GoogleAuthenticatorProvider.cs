...
namespace HodHod.Authentication.TwoFactor.Google;

public class GoogleAuthenticatorProvider : HodHodServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
{
    ...
    public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
    {
        ...
        var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("HodHod", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
