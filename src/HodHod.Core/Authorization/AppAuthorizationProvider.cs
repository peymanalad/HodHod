...
public class AppAuthorizationProvider : AuthorizationProvider
{
    ...
    public override void SetPermissions(IPermissionDefinitionContext context)
    {
        ...
        categories.CreateChildPermission(AppPermissions.Pages_Administration_Categories_Create, L("CreatingNewCategory"));
        categories.CreateChildPermission(AppPermissions.Pages_Administration_Categories_Edit, L("EditingCategory"));
        categories.CreateChildPermission(AppPermissions.Pages_Administration_Categories_Delete, L("DeletingCategory"));

        var subCategories = administration.CreateChildPermission(AppPermissions.Pages_Administration_SubCategories, L("SubCategories"));
        subCategories.CreateChildPermission(AppPermissions.Pages_Administration_SubCategories_Create, L("CreatingNewSubCategory"));
