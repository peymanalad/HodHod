...
public class HodHodMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
{
    private readonly ILocalizationManager _localizationManager;
    private readonly IEmailSettingsChecker _emailSettingsChecker;

    public HodHodMailKitSmtpBuilder(
    ...
    {
        return _localizationManager.GetString(HodHodConsts.LocalizationSourceName, name);
    }
