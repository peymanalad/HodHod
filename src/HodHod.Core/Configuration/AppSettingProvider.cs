...
public class AppSettingProvider : SettingProvider
{
    ...
    {
        if (!HodHodConsts.AllowTenantsToChangeEmailSettings)
        {
        ...
        return new[]
        {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        HodHodConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),
    ...
    private IEnumerable<SettingDefinition> GetDashboardSettings()
    {
        ...
        return new[]
        {
                new SettingDefinition(
                    GetSettingName(
                        HodHodDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        HodHodDashboardCustomizationConsts.Applications.Angular,
    ...
    public Dashboard GetDefaultMvcHostDashboardView()
    {
        ...
        {
            DashboardName = HodHodDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{HodHodDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{HodHodDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = HodHodDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = HodHodDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    HodHodDashboardCustomizationConsts.Widgets.Host
    ...
    public Dashboard GetDefaultMvcTenantDashboardView()
    {
        ...
        return new Dashboard
        {
            DashboardName = HodHodDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{HodHodDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{HodHodDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = HodHodDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = HodHodDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    HodHodDashboardCustomizationConsts.Widgets.Tenant
