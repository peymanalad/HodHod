...
/// </summary>
public class HodHodSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public HodHodSimplePermissionDependency()
    {
    ...
    public HodHodSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public HodHodSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
