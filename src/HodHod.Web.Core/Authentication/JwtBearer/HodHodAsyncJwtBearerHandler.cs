...
public class HodHodAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
{
    ...
    /// </summary>
    /// <inheritdoc />
    public HodHodAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
