...
using HodHod.MultiTenancy.HostDashboard;
...
namespace HodHod.Tests.HostDashboard;
...
public class HostDashboardAppService_Tests : AppTestBase
{
    ...
    private void CreatePaidPayment(HodHodDbContext context, SubscriptionPayment subscriptionPayment)
    {
