...
test.describe('EDITIONS', () => {
    ...
    test.describe('CRUD', () => {
        ...
        test('should hide error when form is properly filled', async () => {
            ...
            await editionsPage.triggerValidation('#EditionDisplayName', '#MonthlyPrice', '#AnnualPrice');
        ...
        async function triggerValidation() {
            await fillInputsWithValidValues();
            await editionsPage.clearInputs('#EditionDisplayName', '#MonthlyPrice', '#AnnualPrice');
        }
